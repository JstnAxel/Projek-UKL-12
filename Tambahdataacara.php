    ...
    <div class="container_py-5" style="max-width: 550px;">
        <form method="post" action="Tambahdata.php" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="deskripsi_acara" name="deskripsi_acara" rows="4" required></textarea>
            </div>
            <div class="mb-3">
                <label for="gambar_acara" class="form-label">Gambar Event</label>
                <input class="form-control" type="file" id="gambar_acara" name="gambar_acara" required>
            </div>
